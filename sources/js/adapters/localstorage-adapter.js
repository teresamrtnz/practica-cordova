var LocalStorageAdapter = function () {
    ...
    this.inicializar = function() {
        ...
        window.localStorage.setItem("futbolistas", JSON.stringify(
          [
    ...
    this.encontrarPorId = function (id) {
        ...
        var deferred = $.Deferred(),
            futbolistas = JSON.parse(window.localStorage.getItem("futbolistas")),
            futbolista = null,
            l = futbolistas.length;
    ...
    this.encontrarPorNombre = function (searchKey) {
        var deferred = $.Deferred(),
            futbolistas = JSON.parse(window.localStorage.getItem("futbolistas")),
            resultados = futbolistas.filter(function (element) {
